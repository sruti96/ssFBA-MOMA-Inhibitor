include("Kinetics.jl")
function Bounds_control(data_dictionary,TXTL_dictionary,species_array,idx)
  ...
  SBA[aa_idx[aa_tmp],1] .= max.(-species[aa_idx[aa_tmp]],data_dictionary["AA_pos"][aa_tmp] .* (-0.01))
  ...
  data_dictionary["default_flux_bounds_array"] = FB
